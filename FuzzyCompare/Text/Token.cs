namespace FuzzyCompare.Text
{
    ...
    /// </summary>
    [DebuggerDisplay("{Category,nq}: {ToString()}")]
    public readonly struct Token : IEquatable<Token>, IEquatable<string>, IEquatable<char>
    {
        ...
        /// </summary>
        public ReadOnlySpan<char> Span => this.source.Span[this.range];
        /// <summary>
        ...
        /// <summary>
        /// Deconstructs the <see cref="Token"/> instance into its constituent parts.
        /// </summary>
